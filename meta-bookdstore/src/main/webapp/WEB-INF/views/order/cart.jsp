											...
											<tbody>
												<tr class="woocommerce-cart-form__cart-item cart_item">
													<td class="product-name" data-title="Product">
														<div class="d-flex align-items-center">
															<a href="#"> <img src="https://placehold.it/80x120"
																class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
																alt="">
															</a>
															<div class="ml-3 m-w-200-lg-down">
																<a href="#">The Overdue Life of Amy Byler</a> <a
																	href="#" class="text-gray-700 font-size-2 d-block"
												...
												<tr class="woocommerce-cart-form__cart-item cart_item">
													<td class="product-name" data-title="Product">
														<div class="d-flex align-items-center">
															...
															<div class="ml-3 m-w-200-lg-down">
																<a href="#">All You Can Ever Know: A Memoir</a> <a
																	href="#" class="text-gray-700 font-size-2 d-block"
																	tabindex="0">Kelly Harms</a>
															</div>
														</div>
												...
												<tr class="woocommerce-cart-form__cart-item cart_item">
													<td class="product-name" data-title="Product">
														<div class="d-flex align-items-center">
															...
															<div class="ml-3 m-w-200-lg-down">
																<a href="#">Winter Garden</a> <a href="#"
																	class="text-gray-700 font-size-2 d-block" tabindex="0">Kelly
																	Harms</a>
															</div>
														</div>
													</td>
												...
												<tr>
													<td colspan="5" class="actions">
														...
														type="submit" class="button" name="update_cart"
														value="Update cart"> <input type="hidden"
														id="_wpnonce" name="_wpnonce" value="db025d7a70"><input
					...
					<div id="cartAccordion"
						...
						<div class="p-4d875 border">
							<div id="cartHeadingTwo" class="cart-head">
								<a
									class="d-flex align-items-center justify-content-between text-dark"
									href="#" data-toggle="collapse" data-target="#cartCollapseTwo"
									aria-expanded="true" aria-controls="cartCollapseTwo">
							...
							<div id="cartCollapseTwo" class="mt-4 cart-content collapse show"
								...
								<ul id="shipping_method">
									<li><input type="radio" name="shipping_method[0]"
										...
										for="shipping_method_0_flat_rate1">Free shipping</label></li>
									...
									<li><input type="radio" name="shipping_method[0]"
										...
										value="flat_rate:2" class="shipping_method" checked="checked">
										<label for="shipping_method_0_flat_rate3">Local
											pickup:: <span class="woocommerce-Price-amount amount"><span
						...
						<div class="p-4d875 border">
							<div id="cartHeadingThree" class="cart-head">
								<a
									...
									data-target="#cartCollapseThree" aria-expanded="true"
